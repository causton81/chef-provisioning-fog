      ...
      module Providers
        class SoftLayer < FogDriver::Driver
          ...
          def set_post_install_info(server, bootstrap_options)
            # specs_and_options[machine_spec][:bootstrap_options][:postInstallScriptUri]
...
SHELL
                ...
                bootstrap_options[:postInstallScriptUri] = 'https://dal05.objectstorage.service.networklayer.com/v1/AUTH_b1b23a05-1c03-4961-8b08-2339886e476f/dist/sl-post-hook.sh'
